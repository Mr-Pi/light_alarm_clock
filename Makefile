...
LUA_FILES := init.org.lua httpserver.lua httpserver-request.lua httpserver-basicauth.lua base64_v2.lua httpserver-conf.lua httpserver-static.lua httpserver-header.lua httpserver-error.lua time.lua alarm.lua dimmer.lua
