...
wifiConfig.stationPointConfig.ssid = "MyWifiSSID"        -- Name of the WiFi network you want to join
wifiConfig.stationPointConfig.pwd =  "MyWifiPassword"                -- Password for the WiFi network
